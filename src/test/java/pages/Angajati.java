...
public class Angajati {
    ...
    public Angajati(WebDriver driver){
        this.driver=driver;
        wait=new WebDriverWait(driver, Duration.ofSeconds(10));
    }

    //Locators
    private By txtNumeAngajat = By.id("NumeAngajat");
    ...
    private By msgAvertizare = By.xpath("//span[@data-valmsg-for='NumeAngajat']");
    private By btnAdaugaAngajat=By.xpath("//a[@class='btn btn-dark' and contains(text(), 'Adauga angajat')]");
    ...
    //Metode
    public void adaugaNumeAngajat(){
        String numeAngajat= RandomUtils.generateRandomString(6,10);
        wait.until(ExpectedConditions.visibilityOfElementLocated(txtNumeAngajat)).sendKeys(numeAngajat);
    }
    ...
    public boolean esteBtnAdaugaAngajatVizibil() {
        try {
            WebElement element = driver.findElement(btnAdaugaAngajat);
            return element.isDisplayed();
        } catch (org.openqa.selenium.NoSuchElementException | org.openqa.selenium.StaleElementReferenceException | org.openqa.selenium.ElementNotInteractableException e) {
            return false;
        }
